...
- preview smoke не выявил критики;
...
- preview smoke становится ключевым индикатором успеха.
...
- validation и build могут пройти, но логика preview сломается;
...
CheckRunner запускает три класса проверок:
