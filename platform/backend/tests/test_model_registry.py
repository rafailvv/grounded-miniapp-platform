...
from app.ai.model_registry import BALANCED_CODE_MODEL, CODEX_MAX_MODEL, CODEX_MINI_MODEL, QUALITY_CODE_MODEL, TASK_PROFILES, models_for_role
...
def test_unrelated_env_does_not_change_model_routing(monkeypatch) -> None:
    ...
    assert models_for_role("repair", model_profile="openai_code_quality", generation_mode=GenerationMode.QUALITY) == CODEX_MAX_MODEL
