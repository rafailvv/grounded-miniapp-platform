...
class ObservabilityReport(StrictModel):
    ...
    tokens_per_phase: list[dict[str, Any]] = Field(default_factory=list)
    retries_per_run: list[dict[str, Any]] = Field(default_factory=list)
    time_to_completed_product: dict[str, Any] = Field(default_factory=dict)
    cost_by_workspace: list[dict[str, Any]] = Field(default_factory=list)
    model_performance_by_task_type: list[dict[str, Any]] = Field(default_factory=list)
