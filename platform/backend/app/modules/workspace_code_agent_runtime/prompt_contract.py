...
def agent_system_prompt() -> str:
    return (
        ...
        "Each role app needs routeable prompt-derived screens; every child page that exists must be listed in generated/route_manifest.json and reachable through the role route. "
