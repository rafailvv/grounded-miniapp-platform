        ...
        return json_dumps(
            {
                ...
                "constraints": [
                    ...
                    "For role root pages with dynamic data dependencies, require real first-paint sections and actions with honest empty states instead of loading-first shells or pseudo-data rows.",
                    ...
                    "If the prompt requires persistent business data or mutable shared entities, plan miniapp/app/db.py and miniapp/app/schemas.py as canonical backend contract files from the start.",
        ...
        return json_dumps(
            {
                ...
                "constraints": [
                    ...
                    "For role root pages with dynamic data dependencies, require content-first first paint with real sections and honest empty states instead of loading-first shells or pseudo-data rows.",
                    ...
                    "If the prompt requires persistent business data or mutable shared entities, include miniapp/app/db.py and miniapp/app/schemas.py in the backend contract from the start.",
