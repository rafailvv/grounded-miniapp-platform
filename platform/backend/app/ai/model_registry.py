...
CODEX_MAX_MODEL = os.getenv("OPENAI_CODE_MAX_MODEL", "gpt-5.1-codex-max")
FAST_CODE_MODEL = os.getenv("OPENAI_CODE_FAST_MODEL", CODEX_MAX_MODEL)
BALANCED_CODE_MODEL = os.getenv("OPENAI_CODE_BALANCED_MODEL", CODEX_MAX_MODEL)
QUALITY_CODE_MODEL = os.getenv("OPENAI_CODE_QUALITY_MODEL", CODEX_MAX_MODEL)
SUMMARY_MODEL = os.getenv("OPENAI_CODE_SUMMARY_MODEL", CODEX_MAX_MODEL)
REPAIR_MODEL = os.getenv("OPENAI_CODE_REPAIR_MODEL", CODEX_MAX_MODEL)
