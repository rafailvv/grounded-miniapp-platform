...
class ModeProfiles:
    _PROFILES = {
        ...
        GenerationMode.PRODUCTION: ModeProfile(
            mode="production",
            context_code_limit=10,
            context_doc_limit=8,
            targeted_file_limit=32,
            edit_iteration_limit=5,
            repair_attempt_limit=8,
            verification_depth="release",
            compact_aggressiveness="low",
            agent_effort="high",
            editor_effort="high",
            repair_effort="high",
            acceptance_check_multiplier=4,
        ),
