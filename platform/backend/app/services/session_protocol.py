...
class SessionProtocolReducer:
    ...
    def _run_payload(run: RunRecord) -> dict[str, Any]:
        return {
            ...
            "existing_app_map_ref": getattr(run, "existing_app_map_ref", None),
            "improve_slice_ref": getattr(run, "improve_slice_ref", None),
    ...
    def _run_refs(run: RunRecord) -> dict[str, Any]:
        return {
            ...
            "existing_app_map": getattr(run, "existing_app_map_ref", None),
            "improve_slice": getattr(run, "improve_slice_ref", None),
