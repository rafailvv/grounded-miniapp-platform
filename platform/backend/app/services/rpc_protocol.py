...
RPC_PARAM_MODELS: dict[str, type] = {
    ...
    "workbench/events": WorkbenchEventParams,
...
def rpc_protocol_report() -> RpcProtocolReport:
    return RpcProtocolReport(
        ...
        methods=[
            ...
            _method("workbench/events", WorkbenchEventParams, "WorkbenchEventResponse", idempotent=True, description="Read typed Workbench-level v2 events and notifications."),
            _method(
                "thread/list",
                ThreadListParams,
                "ThreadListResult",
            ...
            _method(
                ...
                "RunEventsResponse",
                idempotent=True,
                description="Read typed run events as v2 protocol event states while preserving the legacy event journal endpoint.",
                cursor=RpcCursorPage(cursor_kind="sequence_cursor", cursor_param="after_sequence", next_cursor_field="next_sequence"),
            ),
            ...
            _method("browser/proof", BrowserProofParams, "BrowserProofResponse", idempotent=True, description="Read typed browser proof state for a run."),
            _method("browser/replay_proof", BrowserProofParams, "BrowserReplayProofReport", idempotent=True, description="Read replayable browser proof scenarios for a run."),
            ...
            _method("worker/updates", WorkerUpdateParams, "WorkerUpdateResponse", idempotent=True, description="Read typed worker update payloads for a run."),
