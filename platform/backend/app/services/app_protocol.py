...
APP_PROTOCOL_MODELS: dict[str, type] = {
    ...
    "ProtocolWorkbenchState": ProtocolWorkbenchState,
    ...
    "ProtocolBrowserProofState": ProtocolBrowserProofState,
    "WorkbenchEventParams": WorkbenchEventParams,
    "RunEventsParams": RunEventsParams,
    "WorkerUpdateParams": WorkerUpdateParams,
    "BrowserProofParams": BrowserProofParams,
    "WorkbenchEventResponse": WorkbenchEventResponse,
    "RunEventsResponse": RunEventsResponse,
    "WorkerUpdateResponse": WorkerUpdateResponse,
    "BrowserProofResponse": BrowserProofResponse,
    "WorkbenchNotification": WorkbenchNotification,
    "RunNotification": RunNotification,
    "WorkerUpdateNotification": WorkerUpdateNotification,
    "BrowserProofNotification": BrowserProofNotification,
    "BrowserReplayProofReport": BrowserReplayProofReport,
    "BrowserReplayScenarioReport": BrowserReplayScenarioReport,
...
def app_protocol_manifest() -> AppProtocolManifest:
    return AppProtocolManifest(
        endpoint_refs={
            ...
            "browser_proof": "/runs/{run_id}/browser-proof",
            "browser_replay_proof": "/runs/{run_id}/browser-replay-proof",
        },
        versions=[
            ProtocolVersionSpec(
                version="v1",
        ...
        subjects=[
            ProtocolSubjectSpec(
                subject="workbench",
                purpose="Workbench UI, command, and cross-run lifecycle notifications with typed v2 payloads.",
                v1_payload_model="dict",
                v2_payload_model="ProtocolWorkbenchState",
                source_models=["SystemSchemaManifest", "RunTimelineReport", "RunEventsReport"],
                event_types=["workbench.command.started", "workbench.command.completed", "workbench.view.changed", "workbench.error"],
                legacy_endpoints=["/system/schema", "/slash-commands", "/runs/{run_id}/timeline"],
            ),
            ProtocolSubjectSpec(
                subject="run",
            ...
            ProtocolSubjectSpec(
                subject="browser_proof",
                purpose="Browser acceptance proof, replayable scenarios, screenshots, console/network evidence, and Playwright specs.",
                v1_payload_model="dict",
                v2_payload_model="ProtocolBrowserProofState",
                source_models=["BrowserReplayProofReport", "BrowserReplayScenarioReport", "RunRecord"],
                event_types=["browser_proof.started", "browser_proof.step", "browser_proof.completed", "browser_proof.failed", "browser_proof.replay_built"],
                legacy_endpoints=[
        ...
        rpc_method_models=list(
            dict.fromkeys(
                [
                    ...
                    "WorkerUpdateNotification",
                    "BrowserProofNotification",
                    *[model.__name__ for model in RPC_PARAM_MODELS.values()],
                ]
            )
        ),
        compatibility_rules=[
