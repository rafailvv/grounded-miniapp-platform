...
async function loadProfile() {
  ...
  name.textContent = getDisplayName(profile, "Specialist profile");
  avatar.innerHTML = renderAvatar(profile.photo_url, getInitials(profile, "S"), "avatar", "avatar-fallback");
}
